...
const proxyVersion = config.data!.proxy.version;
...
export const minecraftData = _minecraftData(proxyVersion);

export const LOBBY_LOGIN_PACKET = {
    ...minecraftData.loginPacket
};

LOBBY_LOGIN_PACKET.isHardcore = true;
LOBBY_LOGIN_PACKET.gameMode = 0;
LOBBY_LOGIN_PACKET.dimension.value.infiniburn.value = `${proxyVersion === '1.18.2' ? '#' : ''}minecraft:infiniburn_end`;
