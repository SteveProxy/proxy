...
type RangeOfValue<N extends number> = Partial<TupleOf<unknown, N>>["length"];

export type RangeOf<From extends number, To extends number> = Exclude<RangeOfValue<To>, RangeOfValue<From>> | From;
*/
